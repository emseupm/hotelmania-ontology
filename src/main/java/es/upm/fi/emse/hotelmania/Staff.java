...
* Protege name: cleaner
   */
   private int cleaner;
   public void setCleaner(int value) { 
    this.cleaner=value;
   }
   ...
   /**
* Protege name: receptionistNovice
   */
   private int receptionistNovice;
   public void setReceptionistNovice(int value) { 
    this.receptionistNovice=value;
   }
   public int getReceptionistNovice() {
     return this.receptionistNovice;
   }
...
* Protege name: cookerThreeStars
   */
   ...
   public void setCookerThreeStars(int value) { 
    this.cookerThreeStars=value;
   }
   public int getCookerThreeStars() {
     return this.cookerThreeStars;
   }
